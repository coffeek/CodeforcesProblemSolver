...
public class NumbersTests
{
  ...
  {
    Numbers.PrimeDivisors(0).Should().BeEmpty();
    Numbers.PrimeDivisors(1).Should().BeEmpty();
    Numbers.PrimeDivisors(5).Should().BeEquivalentTo(5);
    Numbers.PrimeDivisors(10).Should().BeEquivalentTo(2, 5);
    Numbers.PrimeDivisors(12).Should().BeEquivalentTo(2, 2, 3);
